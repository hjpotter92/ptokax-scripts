...
function tRegCmds.regme( tUser, sData, sCmd )
	if bRegFlag then
		if tUser then
...
function tRegCmds.passwd( tUser, sData, sCmd )
	if tUser then
		if tUser.iProfile == -1 then
...
function tRegCmds.rmhelp( tUser, sData, sCmd )
	if tUser then
